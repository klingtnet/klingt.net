...
from kn_tools import kn_filters, kn_helpers, kn_constants
import time
...
BLOG_AUTHOR = "Andreas Linz"  # (translatable)
BLOG_TITLE = "klingt.net"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link
SITE_URL = "http://www.klingt.net/"
# This is the URL where nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http://www.klingt.net/"
BLOG_EMAIL = "alinz@klingt.net"
BLOG_DESCRIPTION = "Things and thoughts of an audio and computer geek."  # (translatable)
...
DEPLOY_COMMANDS = {
    'default': [
        'rsync --recursive --update --delete --chown=alinz:http output/* kn:/var/www/sites/blog.klingt.net/'
    ]
}
...
GLOBAL_CONTEXT = {
    "hashit": kn_helpers.hashit,
    "get_date": kn_helpers.get_date,
    'footer_links': [
